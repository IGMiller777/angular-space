...
describe('Service: AuthGuard', () => {
	...
	describe('Test: checkLoggedIn', () => {
		it('should return true', () => {
      const spyCanActivate = jest.spyOn(authServiceMock, 'isLoggedIn').mockReturnValue(true);
      expect(authServiceMock.isLoggedIn()).toBe(true)
		});

		it('should return false', () => {
      const spyCanActivate = jest.spyOn(authServiceMock, 'isLoggedIn').mockReturnValue(false);
